        ...
        <div className="text-white flex lg:flex-row flex-col w-full items-center justify-center py-[20px] md:py-[60px] flex-wrap mx-auto ">
            {data.map((item) => (
                <a
                    ...
                    className="relative mx-auto bg-black border flex hover:shadow-2xl rounded-[24px] hover:border-[#3fffff] ease-in duration-100  border-white md:px-10 p-1    pt-10  m-10 md:pb-10  w-[250px] xl:w-[300px]  2xl:w-[30%]   md:min-h-[350px] md:max-h-[350px] min-h-[300px] max-h-[300px]   "
                >
                    ...
                    <div className="flex justify-between  min-w-full pl-3">
                        <div className="justify-start mx-0 flex flex-col  w-[200px] sm:w-full ">
                            ...
                            <h3 className="pb-10 md:pb-4 text-left text-[#FFFFFFC9] sm:text-xs text-sm 2xl:text-lg  font-[600] leading-[25px] w-[100%]">
